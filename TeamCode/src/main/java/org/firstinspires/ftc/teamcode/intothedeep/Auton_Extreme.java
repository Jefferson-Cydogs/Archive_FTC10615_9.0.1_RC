...
@Autonomous
public class Auton_Extreme extends LinearOpMode {
    ...
    CyDogsChassisDeep myBot = new CyDogsChassisDeep(this);
    ...
    @Override public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            myBot.MoveStraight(700,0.5,200);
            myBot.RotateLeft(90,0.5,100);
            myBot.MoveStraight(200,0.4,200);
            myBot.RotateRight(180,0.4,200);
            myBot.MoveStraight(-500,0.45,150);
            myBot.StrafeRight(300,0.4,200);
            myBot.MoveStraight(600,0.5,200);
            myBot.StrafeRight(600,0.5,200);
            myBot.RotateLeft(90,0.5,200);
            myBot.StrafeRight(100,0.5,200);
            myBot.MoveStraight(-100,0.5,2000);
